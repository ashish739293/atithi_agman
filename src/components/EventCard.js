  ...
  const handleDelete = async () => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          // Call your API to delete the event (use your actual API endpoint here)
          ...
          // Handle API error (e.g., network issues)
        ...
        <div className="mt-4">
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 rounded-full border border-1 text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
              ...
              {filteredData.length > 0 ? (
                filteredData.map((row, index) => (
                  <tr key={index} className="odd:bg-white even:bg-gray-50 hover:bg-gray-100">
                    <td className="px-4 py-2 text-gray-700">{row.srNo}</td>
                    ...
                    <td className="px-4 py-2 text-gray-700">{row.received}</td>
                  </tr>
                ))
              ) : (
                <tr>
